...
@protocol HMSegmentedControlDelegate <NSObject>

-(void) didStartScroll:(HMSegmentedControl *)segmentControl Scroller:(UIScrollView *) scroll;
...
@property (nonatomic, strong) id <HMSegmentedControlDelegate> delegate;
