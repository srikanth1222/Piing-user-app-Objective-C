...
-(void) callAddressSave
{
    ...
    if (!self.isEditingAddress)
    {
        ...
        dict = [NSMutableDictionary dictionaryWithObjectsAndKeys:[[NSUserDefaults standardUserDefaults] objectForKey:USER_ID], @"uid", addressFeild.addressName, @"name", addressFeild.addressLine1, @"line1", addressFeild.addressLine2, @"line2", addressFeild.city, @"city", addressFeild.state, @"state", addressFeild.country, @"country", addressFeild.notes, @"landMark", addressFeild.zipCode, @"zipcode", addressFeild.isAddressDefault, @"default",addressFeild.fno, @"floorNo", addressFeild.uno, @"unitNo", addressFeild.lat, @"lat", addressFeild.lng, @"lon", [[NSUserDefaults standardUserDefaults] objectForKey:USER_TOEKN], @"t", nil];
    }
    else
    {
        dict = [NSMutableDictionary dictionaryWithObjectsAndKeys:[[NSUserDefaults standardUserDefaults] objectForKey:USER_ID],@"uid", addressFeild.addressName, @"name", addressFeild.addressLine1, @"line1", addressFeild.addressLine2, @"line2", addressFeild.city, @"city", addressFeild.state, @"state", addressFeild.country, @"country",addressFeild.notes, @"landMark", addressFeild.zipCode, @"zipcode", addressFeild.isAddressDefault, @"default",addressFeild.fno, @"floorNo", addressFeild.uno, @"unitNo", addressFeild.addressID, @"_id", addressFeild.lat, @"lat", addressFeild.lng, @"lon", [[NSUserDefaults standardUserDefaults] objectForKey:USER_TOEKN], @"t", nil];
    }
